            ...
            <div className='h-full w-screen flex flex-col lg:flex-row mt-40 lg:mt-40'>
                <div className='h-full lg:h-full w-full lg:w-1/2 flex justify-center items-center'>
                    <div className='w-full lg:w-[450px] min-h-[500px] px-5 py-2 lg:px-10 lg:py-10'>
                        ...
                        <p className='text-sm text-slate-700'>- Enter your correct details while Logging In.</p>
    
                        <p className='text-sm text-slate-700'>- Enter your full name in the format: Surname Yourname Fathername.</p>
                        <p className='text-sm text-slate-700'>- Enter your email address.</p>
                        <p className='text-sm text-slate-700'>- Enter your registered email address in the first field.</p>
                        <p className='text-sm text-slate-700'>- Select your college from the list.</p>
                        <p className='text-sm text-slate-700'>- Select your course from the available options.</p>
                        <p className='text-sm text-slate-700'>- Enter your unique roll number as assigned by your institution.</p>
                        <p className='text-sm text-slate-700'>- Enter a secure password for your account.</p>
                        <p className='text-sm text-slate-700'>- Re-enter the same password to confirm..</p>
                        ...
                        <p className='text-sm text-slate-700'>- Ensure all the details entered are accurate and match your official records.</p>
                        <p className='text-sm text-slate-700'>- Use a strong password to secure your account.</p>
                        ...
                        <h1 className='hover:underline hover:decoration-teal-500 mb-4'><a href="">Admin Login? Click here</a></h1>
                        <h1 className='hover:underline hover:decoration-teal-500'><a href="">New Admin Registration? Click here</a></h1>
                    </div>
                </div>
                        ...
                        <form action="" className='w-full h-full flex flex-col justify-center'>
                            ...
                            <div className='flex flex-col md:flex-row gap-10 mb-10'>
                                <div className='flex flex-col mb-10'>
                                    ...
                                    <select name="college" id="college" autoComplete='college' className='border py-2 outline-none w-64 text-slate-700 rounded-md'>
                                ...
                                <div className='flex flex-col mb-5'>
                                    ...
                                    <select name="course" id="course" autoComplete='course' className='border py-2 outline-none w-64 text-slate-700 rounded-md'>
                            ...
                            <div className='flex flex-col md:flex-row gap-10 mb-10'>
                                <div className='flex flex-col mb-10'>
                                    ...
                                    <input type="text" id='rollno' autoComplete='rollno' placeholder='Enter your roll no.' className='w-64 rounded-md h-10 border border-slate-200 outline-none px-2 text-sm'/>
                                </div>  
        
                                <div className='flex flex-col mb-10'>
                                    <div className='mb-2'>
                                        <label htmlFor='aaddharno' className='text-slate-700'>Your Aadhar number</label>
                                        <span className='text-amber-500'> *</span>
                                    </div>
                            ...
                            <div className='w-28 h-10 mb-20 flex justify-center items-center rounded-md bg-amber-500 hover:bg-teal-500 cursor-pointer'>
                                <input type="button" value="REGISTER" className='font-semibold text-white cursor-pointer'/>
                            </div>
