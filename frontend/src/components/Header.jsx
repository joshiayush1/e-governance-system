    ...
    <header className='fixed z-10 h-24 w-screen bg-white max-w-screen overflow-x-hidden'>
        <div className="navbar h-24 w-full text-white flex justify-between">
            ...
            <ul className='menuItems lg:flex justify-evenly items-center h-full lg:w-3/6 font-bold hidden text-slate-700'>
                ...
                <li className='hover:text-amber-500 cursor-pointer duration-700 px-5'>EDUCATION FEES</li>
                <li className='hover:text-amber-500 cursor-pointer duration-700 px-5'> <Link to="/institutions">INSTITUTIONS</Link></li>
                <li className='hover:text-amber-500 cursor-pointer duration-700 px-5'>CONTACT</li>
                    ...
                    {toggleMenu && (
                        <div className='w-72 h-72 absolute bg-white mt-80 mr-64'>
                            <div className='flex flex-col text-slate-700 font-medium text-xl gap-4'>
                                <h1 className='hover:text-amber-500 cursor-pointer duration-700 px-5'><Link to="/">HOME</Link></h1>
                                <hr />
